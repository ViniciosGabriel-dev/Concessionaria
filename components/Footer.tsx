      ...
      <div className="container footer__grid">
        ...
        <div className="footer__brand">
          ...
          <div className="ft__social-links">
            <a href={INSTAGRAM} target="_blank" rel="noopener noreferrer" className="ft__social-btn ft__social-btn--insta">
            ...
            <a href={FACEBOOK} target="_blank" rel="noopener noreferrer" className="ft__social-btn ft__social-btn--face">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer__col">
          ...
          <a href="/#financiamento">Financiar</a>
